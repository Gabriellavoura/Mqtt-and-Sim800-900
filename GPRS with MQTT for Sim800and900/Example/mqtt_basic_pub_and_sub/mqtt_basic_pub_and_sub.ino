...
#define GSMAPN "gprs.oi.com.br" //APN
#define GSMUSER "oi"            //APN USER
#define GSMPASSWORD "oi"        //APN PASSWORD
...
char server[] = "broker.hivemq.com";  //Mqtt Server
...
PubSubClient client(server, 1883, callback, s800); // Pass the server, port, callback, and client.
...
void pub()
{
  ...
  client.publish("potato","bye bye"); // topic potato,payload byebye
}
